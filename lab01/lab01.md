...
2. Проверьте содержимое ответа сервера. Вернул ли сервер содержимое файла явно? Как вы
   это можете увидеть?
   - Да
   - Есть поле `Line-based text: text/html`, есди его развернуть, то видно
```
<html>
...
4. Какой код состояния HTTP и фраза возвращаются сервером в ответ на этот второй запрос
   ...
   - 304 Not Modified
   - Нет
![image](https://github.com/user-attachments/assets/e52650a9-5097-4c26-bc5a-0faad50a17e9)
...
4. Есть ли в передаваемых данных какая-либо информация заголовка HTTP, связанная с
   сегментацией TCP?
   - Разве что суммарный размер сегментов, а про то, как именно разделенно на сегменты - нет
![image](https://github.com/user-attachments/assets/8f065473-8390-4f29-8fcc-223c70494675)
...
2. Можете ли вы сказать, загрузил ли ваш браузер два изображения последовательно или
   ...
   - Последовательно, get-запрос на вторую картинку был отправлен только после получения первой
![image](https://github.com/user-attachments/assets/bcf3c2b6-53f3-42bf-914c-d3a996d54c56)
...
![image](https://github.com/user-attachments/assets/d79e03fa-758b-417c-9960-da361e829bca)
![image](https://github.com/user-attachments/assets/48de0610-57ab-48f8-a3a1-c73bfc4029b1)
